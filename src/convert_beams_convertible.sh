...
python cst2prisim_fits.py -b beamlist_convertible.txt -f freq_list_convertible.txt -i False -r False -q True -o /Users/ewallwic/Dropbox_MIT/Science/simulations-hera-eox/data/simulations/Sinuous_Beams
