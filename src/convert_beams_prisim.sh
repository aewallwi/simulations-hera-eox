...
#python cst2prisim_fits.py -b beamlist_sinuous.txt -f freq_list_sinuous.txt -o /Users/ewallwic/Dropbox_MIT/Science/simulations-hera-eox/data/simulations/Sinuous_Beams/
