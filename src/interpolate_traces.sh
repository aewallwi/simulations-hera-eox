...
ttdir1=/Users/ewallwic/Dropbox_MIT/Science/AntennaDataHERA/Cambridge\ UK\ results/AdditionalData/
...
python standardize_time_series.py -i ${ttdir1}HERA-dish-100ohm-input-signal-50-250MHz.txt -o ${ttdir1}HERA-dish-100ohm-output-voltage-50-250MHz.txt -n ${vdir}hera_100ohm_interp.txt
